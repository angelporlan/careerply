...
export default function ApplicationRow({ href, company, location, position, type, date, status, iconBg }: AppRowProps) {
  return (
    <Link href={href} className="block group">
      <div className="grid grid-cols-12 items-center gap-4 py-6 px-4 hover:bg-surface-container-lowest rounded-2xl transition-all group">
        ...
        <div className="col-span-1 flex justify-end">
          <span className="p-2 text-on-surface/20 group-hover:text-on-surface transition-colors">
